...
from eaia.gmail_utils import extract_message_part, get_recipients, parse_time
...
async def fetch_group_emails(
    ...
    for message in messages:
        try:
            ...
            logger.exception("Failed processing gmail message", extra={"message": message})
...
def send_calendar_invite(
    ...
    try:
        ...
        logger.exception("Error sending calendar invite")
        return False
